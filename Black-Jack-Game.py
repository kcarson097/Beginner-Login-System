...
def take_bet(chips):
    while True:
        ...
        try:
            ...
            print('Sorry you must enter a integer value !')
            print('\n')
        else:    
...
#function to display players cards

def show_some(player,dealer):
    print('The players cards are :')
    print('\n')
    print(*player.cards)
    print('The dealers cards (first card hidden) are:')
    print('\n')
...
While True:
    ...
    print('The players chips total is now:')
    print('\n')
